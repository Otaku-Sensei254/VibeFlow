...
//  Continue  opencode -s ses_0d6f5325affeAKgfUfDkPdP9zV
...
const navItems = [
  ...
  { path: "/creator-hub", label: "Creator Hub", icon: "M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" },
  { path: "/admin/communications-hub", label: "Communication Hub", icon: "M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" },
];
    ...
    <>
      ...
      >
        <div className="h-16 flex items-center justify-between px-6 border-b border-gray-100 dark:border-zinc-800">
          <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-tide-600 to-flow-600">
            VibeFlow Admin
          </span>
          <button
            onClick={onClose}
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-all ${
                  active
                    ? "bg-tide-50 dark:bg-tide-900/20 text-tide-600 dark:text-tide-400"
          ...
          <div className="p-4 border-t border-gray-100 dark:border-zinc-800">
            <div className="flex items-center gap-3">
              <Link to={`/profile/${user.username}`} onClick={onClose} className="shrink-0">
                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-tide-500 to-flow-500 flex items-center justify-center text-white font-bold text-xs overflow-hidden hover:ring-2 ring-tide-400 transition-all">
                  {user.avatar_url ? (
              ...
              <Link to={`/profile/${user.username}`} onClick={onClose} className="flex-1 min-w-0">
                <p className="text-sm font-medium text-gray-900 dark:text-white truncate hover:text-tide-600 dark:hover:text-tide-400 transition-colors">{user.username}</p>
